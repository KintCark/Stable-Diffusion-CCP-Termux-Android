...
pkg install git cmake python wget && pkg install libwebp &&  pip install nodejs && pip install npm && npm install -g npm@12.0.2 && pkg install nodejs-lts && pkg update && pkg install pnpm && pip install update setuptools
